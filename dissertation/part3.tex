...
\item[(1)] Множество $F_\bma$ несчетно, если существует $\bmb\succcurlyeq\bma$ такое, что $\#G_\bmb>1$;

\item[(2)] Множество $F_\bma$ счетно, если для любого $\bmb\succcurlyeq\bma$ верно неравенство $\#G_\bmb\leq1$;

\item[(3)] Множество $F_\bma$ конечно, если для всех максимальных вершин $\bmb$ в $\Gamma_\bma$, верно $\#G_\bmb=1$ и $G_{\bmb}=\0$ для всех остальных вершин в $\Gamma_\bma$.
...
\item[(4)] Множество $F_\bma$ является одноточечным, если все $\bma_i\succcurlyeq\bma$ образуют цепочку $\bma=\bma_1\prec\ldots\prec\bma_p$, в которой для всех $j\le p-1$, $\# G_{\bma_j\bma_{j+1}}=1$, $G_{\bma_j}=\0$ и $\#G_{\bma_p}=1$;
\end{enumerate}
\end{theorem}


\begin{proof}
(1) Если $\#G_{\bmb\bmb}> 1$, то $F_\bma$ содержит в себе фрактальный $k$-куб с множеством единиц $G_{\bmb\bmb}$, который имеет мощность континуума.\\
