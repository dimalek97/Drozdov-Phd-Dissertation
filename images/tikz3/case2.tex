...
\begin{tikzpicture}
    ...
    \foreach \x in
        {(1,-1), (0,1),  (2,0), (1,2), (0,0), (2,1),% case (A) green
         (5,-1), (4,0),  (5,2), (6,2), (4,-1), (6,1), % case (C) green
         (8,-1), (10,0), (8,1),  (10,2), (9,-1), (8,0), (10,1), (9,2) % case (D6) green
        } 
...
%        {\draw[green, line width=0.4mm] \x rectangle+(1,1);}
    ...
    % case (A) bound
    \foreach \x in
        {(1,-1), (0,1), (2,0), (1,2), (1,0), (1,1),(0,0), (2,1)} 
    ...
    % case (C) bound
    \foreach \x in
        {(5,-1), (4,0), (5,2), (6,2), (5,0), (5,1), (4,-1), (6,1)} 
    ...
    % case (D6) bound
    \foreach \x in
        {(8,-1), (10,0), (8,1), (10,2), (9,0), (9,1), (9,-1), (8,0), (10,1), (9,2)}
        {\draw[bluearrow] \x++(0.25,0.25) -- ++(-0.25,-0.25);
         \draw[bluearrow] \x++(0.75,0.75) -- ++(.25,0.25);
         \draw[bluearrow] \x++(0.3,0.5) -- ++(-0.3,0);
         \draw[bluearrow] \x++(0.7,0.5) -- ++(0.3,0);
...
%    \node[shift={(10.5,0.5)},above right] {$8$};
    ...
    \node at (4.1,2.8){\LARGE{\bf C}};
    \node at (8.1,2.8){\LARGE{\bf D6}};
\end{tikzpicture}
\end{document}