...
\draw[line width=0.5mm, blue, fill=blue!25, rounded corners=2mm] 
    ...
    (6,0) ..controls+(1,0.4).. 
    (8,0) ..controls+(0,3).. 
    (10,5) ..controls+(-1,3).. cycle;
\fill[red] foreach \a in 
    {(0,0), (2,0), (4,0), (6,0), (8,0), (0,5),
     (2,10), (4,10), (6,10), (8,10), (10,10), (10,5)}
    {\a circle (1.5mm)};
\foreach \a/\b in 
...
\node[left=2mm] at (0,5) {$A'$};
\node[right=2mm] at (10,5) {$B'$};
\foreach \a/\b in 
    {(1,5)/1, (5,5)/2, (9,5)/3}
...
\foreach \a in 
    ...
    {\node at \a {\includegraphics[width=3.42cm]{constr1clear3.pdf}};};
\foreach \a in 
